...
class Translator(object):
    ...
    def translate(self,
        ...
        if (step != -1):
            ...
            self.logger.info(f'Rouges at step {step} \n {rouges}')
            if self.tensorboard_writer is not None:
                try:
                    ...
                    print("Using a different rouge score report.")
    ...
    def _fast_translate_batch(self,
        ...
        for step in range(max_length):
            ...
            alive_seq = torch.cat(
                [alive_seq.index_select(dim = 0, index = select_indices.type(torch.LongTensor).to(device)), topk_ids.view(-1, 1)], -1)
